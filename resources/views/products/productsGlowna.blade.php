        ...
        <div class="col-lg-4 col-md-3 col-sm-6 portfolio-item">
            <div class="card h-100" style="background: none; border: none;">
                ...
                <a href="{{route('torty.index')}}">
                    ...
                    <img class="card-img-top" style="border-radius: 30px; border: solid 1px; border-color: rgba(47,23,15,.9); box-shadow: 5px 5px 10px darkgray;" src='{{url("/temp/img/produkty/intro.jpg")}}' alt=""></a>
        ...
        <div class="col-lg-4 col-md-3 col-sm-6 portfolio-item">
            <div class="card h-100" style="background: none; border: none;">
                ...
                <a href="{{route('products.index')}}">
                    ...
                    <img class="card-img-top" style="border-radius: 30px; border: solid 1px; border-color: black; box-shadow: 5px 5px 10px grey;" src='{{url("/temp/img/produkty/about.jpg")}}' alt="" ></a>
        ...
        <div class="col-lg-4 col-md-3 col-sm-6 portfolio-item">
            <div class="card h-100" style="background: none; border: none;">
                ...
                <a href="{{route('ciasteczka.index')}}">
                    ...
                    <img class="card-img-top" style="border-radius: 30px; border: solid 1px; border-color: black; box-shadow: 5px 5px 10px grey;" src='{{url("/temp/img/produkty/bg.jpg")}}' alt=""></a>
