            ...
            <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item" >
                <div class="card h-100" style="background: none; border: none;">
                    ...
                    <a href="{{route('tort.show',['id'=>$tort->id])}}">
                        ...
                        <img class="card-img-top" style="border: solid 1px; border-color: rgba(47,23,15,.9); border-radius: 25px; box-shadow: 3px 3px 7px darkgray;" src='{{url("/storage/products_img/".$tort->filename)}}' alt=""></a>
