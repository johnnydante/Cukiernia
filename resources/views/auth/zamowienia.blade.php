                    ...
                    <div class="cta-inner rounded">
                        ...
                        <div class="row" style="margin-bottom: 30px; margin-top: -50px;">
                            ...
                            @foreach($orders->where('status', 'oczekuje') as $order)
                                <b style="border-top: solid 1px; border-bottom: dashed 3px antiquewhite; border-right: solid 1px; border-left: solid 1px; z-index: 50;"> {{$order->getUser()->name}} {{$order->getUser()->surname}} -
                                    {{$order->getUser()->email}} - tel: {{$order->getUser()->tel}}</b>
                                ...
                                <div class="row" style="border-top: 1px solid; padding-top: 5px;">
                                    ...
                                    <div class="col text-center" style="margin-top: 5px;">
                                       <b>Status:</b> {{ $order->status }}<br>
                                        ...
                                        <div class="intro-button mx-auto" style="margin-top: 5px;">
                                            <a onclick="return confirm('Czy na pewno chcesz przekazać do realizacji?')"
                                               class="btn btn-success btn-x2"
                                               href="{{ route('order.updateDoRealizacji', ['id' => $order->id])}}">
                            ...
                            <div class="row" style="border-top: 1px solid; padding-top: 5px;">
                                ...
                                <div class="col text-center" style="margin-top: 5px;">
                                    ...
                                    <div class="intro-button mx-auto" style="margin-top: 5px;">
                                        <a onclick="return confirm('Czy na pewno chcesz wycofać zamówienie?')"
                                           class="btn btn-danger btn-x2"
                                           href="{{route('tort_order.delete', ['id' => $tort->id])}}">
                                            Wycofaj
                                        </a>
                                    </div>
                                    @if($tort->cena == null)
                                    ...
                                    @else
                                         Cena: <b>{{$tort->cena}}</b> zł<br>
                                            <div class="intro-button mx-auto" style="margin-top: 5px;">
                                                <a onclick="return confirm('Czy na pewno chcesz przekazać do realizacji?')"
                                                   class="btn btn-success btn-x2"
                                                   href="{{ route('order.updateTortDoRealizacji', ['id' => $tort->id])}}">
                                                    Przekaż do realizacji
                                                </a>
                                            </div>
                                        <div class="intro-button mx-auto" style="margin-top: 5px;">
                                            <a class="btn btn-info btn-x2" href="{{ route('cenaTortu.delete', ['id' => $tort->id])}}">
                                                Zmień cenę
                                            </a>
                                        </div>
                                    @endif
                            ...
                            <div class="row" style="border-top: 1px solid; padding-top: 5px;">
                                ...
                                <div class="col text-center" style="margin-top: 5px;">
                                    ...
                                    <div class="intro-button mx-auto" style="margin-top: 5px;">
                                        <a onclick="return confirm('Czy na pewno chcesz wycofać zamówienie?')"
                                           class="btn btn-danger btn-x2"
                                           href="{{route('wesele.delete', ['id' => $wesele->id])}}">Wycofaj
                                        </a>
                                    </div>
                                    ...
                                    @else
                                        ...
                                        <div class="intro-button mx-auto" style="margin-top: 5px;">
                                            <a onclick="return confirm('Czy na pewno chcesz przekazać do realizacji?')"
                                               class="btn btn-success btn-x2"
                                               href="{{ route('wesele.updateDoRealizacji', ['id' => $wesele->id])}}">Przekaż do realizacji</a>
                                        </div>
                                        <div class="intro-button mx-auto" style="margin-top: 5px;">
