                            ...
                            <b style="border-top: solid 1px; border-bottom: dashed 3px antiquewhite; border-right: solid 1px; border-left: solid 1px; z-index: 50;"> {{$order->getUser()->name}} {{$order->getUser()->surname}} - {{$order->getUser()->email}} - tel: {{$order->getUser()->tel}}</b>
                                    ...
                                    <div class="col text-center" style="margin-top: 20px;">
                                        ...
                                        <div class="intro-button mx-auto" style="margin-top: 5px;">
                                            <a onclick="return confirm('Czy na pewno chcesz zakończyć realizację?')" class="btn btn-success btn-x2" href="{{route('order.updateZrealizowane', ['id' => $order->id])}}">Zakończ realizację</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @foreach($torty->where('status', 'w realizacji') as $tort)
                            ...
                            <div class="row" style="border-top: 1px solid; padding-top: 5px;">
                                ...
                                <div class="col text-center" style="margin-top: 5px;">
                                    ...
                                    <div class="intro-button mx-auto" style="margin-top: 5px;">
                                        <a onclick="return confirm('Czy na pewno chcesz zakończyć realizację?')" class="btn btn-success btn-x2" href="{{route('order.updateTortZrealizowane', ['id' => $tort->id])}}">Zakończ realizację</a>
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-left: 20px; margin-right: 20px;">
