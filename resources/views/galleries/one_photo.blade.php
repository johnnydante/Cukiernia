...
@section('content')
    ...
    <div class="container" style="margin-bottom: 30px; margin-top: 30px; text-align: center;">
        ...
        <div class="card h-100">
            <div class="numer" style="z-index: 10; min-width: 72px; background-color: rgba(47,23,15,.9); color: darkgray; padding: 15px; position: absolute; right: 3px; bottom: 3px;  border-radius: 36px; text-align: center;"><h3><b>{{$number-1}}</b></h3></div>
